...
class Symato:
	...
	def is_sym_capitalized(self, token_id): return token_id == 2814 # viết hoa toàn bộ âm tiết
	def is_capitalized(self, token_id): return token_id == 2814 or token_id == 2815 # viết hoa chữ đầu hoặc toàn bộ
	...
	# Biến đổi chuỗi token_ids thành utf-8 string: VD: [274, 256, 2815, 274, 258] => "a À"
